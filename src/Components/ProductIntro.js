...
export default function ProductIntro() {
  return (
    <>
    <h2 style={{color:"white",textAlign:"center",fontFamily:"Concert One",fontSize:"3rem"}}>Our<span style={{color:"#79a9fc"}}> Products</span></h2>
      <main className="container">
        ...
        <section className="card card-blue">
          <div className="product-image">
            <img
              src="../assets/purse.png"
              alt="Elegancy-Jaipur print"
              draggable="false"
            />
          </div>
          <div className="product-info">
            <h2>Zari X Peach</h2>
            <p>Purse 1 peachy Handcarry "Off-White - UNC" sneakers</p>
            <div className="price">$1599</div>
          </div>
          <div className="btn">
            <button className="buy-btn">Buy Now</button>
        ...
        <section className="card card-blue">
          <div className="product-image">
            <img
              src="../assets/hodie.png"
              alt="OFF-white Blue Edition"
              draggable="false"
            />
          </div>
          <div className="product-info">
            <h2>Krish X Grey-Black</h2>
            <p>Air Jordan 1 Retro High "Off-White - UNC" sneakers</p>
            <div className="price">$1599</div>
          </div>
          <div className="btn">
